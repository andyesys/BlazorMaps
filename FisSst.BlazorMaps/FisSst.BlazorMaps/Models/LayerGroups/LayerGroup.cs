...
public class LayerGroup : Layer
{
    ...
    public async Task RemoveLayerIds(long[] layerIds) => await batchingJsInterop.RemoveLayerIds(this, layerIds);

    public async Task<long[]> CreateAndAddMarkersBatched(LatLng[] latLngs, MarkerOptions[] options, IconOptions[] iconOptions = null) => await batchingJsInterop.CreateAndAddMarkersBatched(this, latLngs, options, iconOptions);
